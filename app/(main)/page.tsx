...
const homeCopy: Record<Locale, {
  ...
  zh: {
    ...
    readySubtitle: 'Larry Math 是全免费开放的公益课程；付费课程也开放前几节免费试学，让孩子先体验视频和练习节奏。',
    statCourses: '课程入口',
    statLessons: '视频课节',
    statQuestions: '互动题目',
    statPreview: '免费试学',
  ...
  en: {
    ...
    readySubtitle: 'Larry Math is a fully free public-benefit course. Paid courses also include free preview lessons before students unlock the full path.',
...
const showcaseCourses: CourseShowcase[] = [
  {
    ...
    copy: {
      ...
      en: {
        ...
        detail: '¥199 with a 5 MP autofocus camera or ¥99 stand-only; both ship by SF Express for ¥18.',
        preview: '¥99 / ¥199 + ¥18 SF Express',
        cta: 'View and buy',
      },
    },
  },
  ...
  },
  {
    ...
    copy: {
      zh: {
        ...
        detail: 'Larry 本人的数学小讲师课程全免费开放，按年级和知识点整理，帮助更多孩子用自己的节奏补基础、练思维。',
        preview: '公益课程 · 全部免费',
        cta: '免费学习 Larry Math',
      },
      en: {
        title: 'Larry Math',
        eyebrow: 'Free public course',
        line: 'Larry started teaching math on video at age six. Learning from a peer makes math feel possible.',
        detail: 'Larry’s own peer-teaching math course is fully free, organized by grade and skill so more students can build confidence at their own pace.',
        preview: 'Public benefit · Fully free',
        cta: 'Learn Larry Math free',
      },
    },
  },
]
