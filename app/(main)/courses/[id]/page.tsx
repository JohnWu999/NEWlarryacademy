...
const courseDescriptionOverrides: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'course-ngss-science-g4': 'G4 NGSS 科学完整开放：从结构与功能、植物和动物结构、感官与大脑反应，到能量、波、光、地表变化、化石、资源、自然灾害和工程设计，20 节视频配套 200 道循序渐进练习。',
  ...
  en: {
    ...
    'course-ngss-science-g4': 'Grade 4 NGSS Science is open: 20 phenomenon-based lessons and 200 scaffolded practice questions across structure and function, plant and animal structures, senses and response, energy, waves, light, Earth surface change, fossils, resources, hazards, and engineering design.',
...
function courseVisualImages(course: { id: string; courseTrack: string; thumbnailUrl?: string | null }) {
  if (course.id === 'course-ngss-science-g4') {
    return [1, 3, 5, 7, 9, 11, 13, 15, 17].map((number) => `/lesson-covers/ngss-g4/lesson-${String(number).padStart(2, '0')}.jpg`)
  }
