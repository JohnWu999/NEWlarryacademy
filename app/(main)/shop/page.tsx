        ...
        {product ? (
          <article className="mt-10 grid overflow-hidden rounded-[2.5rem] border border-white/10 bg-white/[0.035] shadow-2xl shadow-violet-950/30 lg:grid-cols-[0.9fr_1.1fr]">
            ...
            <div className="flex flex-col justify-center p-7 sm:p-10 lg:p-14">
              ...
              <p className="mt-5 max-w-xl text-base leading-8 text-white/60">升级高度的炫彩桌面 AI 学习支架，提供配备 500 万像素摄像头与不带摄像头两种型号，两个型号分别管理库存。</p>
              ...
              <div className="mt-8 flex flex-wrap gap-2">
                {['500 万像素摄像头可选', '解决原来的高度问题', '炫彩款', '顺丰配送'].map((label) => (
