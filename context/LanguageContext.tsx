...
const translations = {
  zh: {
    ...
    'about.title': '关于 Larry Academy',
    'about.mission': 'Larry 的故事',
    'about.mission.kicker': '从行走欧洲到创造学习平台',
    'about.mission.p1': '从 6 岁开始，Larry 跟随家人行走欧洲。那也是 ChatGPT 刚刚诞生的时代，他成长在 AI 开始改变学习方式的一代。通过与 AI 合作，他探索数学、历史、写作、编程和许多跨学科知识，逐渐体验到一种几乎无界的学习方式。',
    'about.mission.p2': 'Larry 特别喜欢数学。从 6 岁开始，他每周录制一期《数学小讲师》，用给同龄人讲题的方式激励自己，也帮助更多小朋友发现数学可以很有趣、很清楚、很有成就感。',
    'about.mission.p3': '在这段旅程中，Larry 出版了自己的书 Walking in Ages，中文名《七岁行欧洲》。那本书记录了一个孩子如何观察世界、提出问题、连接知识，也成为 Larry Academy 的起点之一。',
    'about.mission.p4': '当 Larry 进入 AI coding 领域，他意识到自己不只能学习，也可以创造工具帮助别人学习。Larry Academy 正是从这个想法开始：用 AI、视频、互动练习、游戏和未来的 3D 教具，做一个由学生创造、面向学生、也面向未来的学习平台。',
    'about.book.title': 'Walking in Ages',
    'about.book.subtitle': '《七岁行欧洲》',
    'about.book.desc': '一本由孩子视角写下的欧洲探索记录，也是 Larry 学会观察、表达和连接知识的重要旅程。',
    ...
    'tools.get': '如何获得这些工具？',
    'tools.available': '可用工具库',
    'tools.visual.title': '可视化学习',
    'tools.visual.desc': '将抽象概念转化为具体可见的模型',
    'tools.tactile.title': '触觉体验',
    'tools.tactile.desc': '通过触摸和操作加深理解和记忆',
    'tools.practice.title': '实践应用',
    'tools.practice.desc': '在实际操作中理解数学原理',
    'tools.download.title': '下载文件',
    'tools.download.desc': '下载 3D 打印文件，使用自己的打印机制作',
    'tools.download.btn': '浏览文件库',
    'tools.bundle.title': '课程配套',
    'tools.bundle.desc': '部分付费课程会赠送配套的 3D 打印教具',
    'tools.bundle.btn': '查看课程',
    'tools.view': '查看详情',
    'profile.title': '个人中心',
  ...
  en: {
    ...
    'about.title': 'About Larry Academy',
    'about.mission': "Larry's Story",
    'about.mission.kicker': 'From exploring Europe to building a learning platform',
    'about.mission.p1': 'Larry began traveling through Europe when he was six. It was also the moment when ChatGPT had just arrived, and he grew up as part of a generation learning inside the AI era. By working with AI, he explored math, history, writing, coding, and many cross-disciplinary ideas, discovering a way of learning that felt almost boundaryless.',
    'about.mission.p2': 'Math became one of his deepest interests. Starting at age six, Larry recorded a weekly mini math lecture, using peer teaching to motivate himself and help other children see that math can be clear, playful, and rewarding.',
    'about.mission.p3': 'Along the way, Larry published his own book, Walking in Ages, known in Chinese as 七岁行欧洲. The book records how a child observes the world, asks questions, and connects knowledge across places and cultures.',
    'about.mission.p4': 'When Larry stepped into AI coding, he realized he could do more than learn: he could build tools that help others learn. Larry Academy began from that idea: a student-built platform for students, combining AI, video, interactive practice, games, and future 3D learning tools to support continuous growth.',
    'about.book.title': 'Walking in Ages',
    'about.book.subtitle': '七岁行欧洲',
    'about.book.desc': "A young explorer's record of Europe, written from a child's point of view, and an early step in Larry's journey of observing, expressing, and connecting knowledge.",
    ...
    'tools.visual.title': 'Visual Learning',
    'tools.visual.desc': 'Transform abstract concepts into concrete visible models',
    'tools.tactile.title': 'Tactile Experience',
    'tools.tactile.desc': 'Deepen understanding and memory through touch and manipulation',
    'tools.practice.title': 'Practical Application',
    'tools.practice.desc': 'Understand math principles in actual operation',
    'tools.download.title': 'Download Files',
    'tools.download.desc': 'Download 3D print files and make them with your own printer',
    'tools.download.btn': 'Browse Files',
    'tools.bundle.title': 'Course Bundle',
    'tools.bundle.desc': 'Some paid courses include matching 3D printed teaching aids',
    'tools.bundle.btn': 'View Courses',
    'tools.view': 'View Details',
