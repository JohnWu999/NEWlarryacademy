...
const translations = {
  zh: {
    ...
    'home.hero.subtitle': '用创新的 3D 技术和互动游戏，让数学学习变得生动有趣。开启您的未来学习之旅。',
    ...
    'home.charity.desc': '每 100 元人民币收入中，我们将捐赠 5 元给 Free Sky Fund，帮助更多孩子获得优质教育机会。',
    ...
    'footer.desc': '用创新科技让数学学习更有趣。开启您的未来学习之旅。',
    'footer.links': '快速链接',
    'footer.about': '关于我们',
    'footer.contact': '联系方式',
    ...
    'shop.title': '在线商店',
    'shop.subtitle': '3D 打印教具和学习材料，让抽象概念变得具体可感。',
    'shop.stock': '库存',
    'shop.buy': '加入购物车',
    'shop.soldout': '售罄',
    'tools.title': '3D 打印工具',
  ...
  en: {
    ...
    'home.hero.subtitle': 'Master math through innovative 3D technology and interactive games. Embark on your future learning journey.',
    'home.hero.start': 'Start Learning',
    'home.hero.shop': 'Visit Shop',
    ...
    'home.charity.desc': 'For every 100 RMB in revenue, we donate 5 RMB to the Free Sky Fund to help more children access quality education.',
    ...
    'footer.desc': 'Making math learning fun with innovative technology. Embark on your future learning journey.',
    ...
    'shop.subtitle': '3D printed tools and learning materials to make abstract concepts tangible.',
    'shop.stock': 'Stock',
