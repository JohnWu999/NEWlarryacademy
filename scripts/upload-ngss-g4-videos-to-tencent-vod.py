...
SOURCE_ROOT = None
COURSE_DATA = PROJECT_ROOT / "data" / "ngss-g4-science-course.json"
VOD_MAP = PROJECT_ROOT / "data" / "ngss-g4-vod-map.json"
...
def main():
    ...
    for lesson in course["lessons"]:
        ...
        source_root = pathlib.Path(course.get("sourceRoot") or "/Users/johnwu/Documents/自动视频剪辑项目/output/NGSS_G4_Science")
