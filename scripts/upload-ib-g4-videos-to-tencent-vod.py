...
COURSE_DATA = PROJECT_ROOT / "data" / "ib-pyp-g4-course.json"
VOD_MAP = PROJECT_ROOT / "data" / "ib-pyp-g4-vod-map.json"
...
def video_path_for(lesson):
    ...
    return SOURCE_ROOT / f"ib_pyp_g4_ep{episode}" / file_name
