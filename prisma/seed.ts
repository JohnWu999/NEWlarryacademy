...
async function main() {
  ...
  const ngssCourses = [
    ...
    },
    {
      ...
      description: 'A complete Grade 7 NGSS pathway: cells, body systems, genetics, natural selection, waves, light, Earth systems, climate evidence, ecosystem protection, and engineering design come together through phenomenon videos and practice.',
      gradeLevel: 'G7',
      ...
      price: 19,
      difficultyLevel: 'intermediate',
      expectedFeatures: ['20 phenomenon lessons', '200 practice questions', 'Life science and Earth systems', 'Open-response evidence explanations'],
      duration: 300,
    },
    {
  ...
  const products = [
    ...
    [
      ...
      '小问号 AI Tutor 支架 2.0 · 炫彩款（带 500 万像素自动对焦摄像头）',
      '升级高度的炫彩桌面 AI 学习支架，配备 500 万像素自动对焦摄像头。螺旋造型搭配稳固圆底座，每件成品都有自然变化的炫彩纹理。',
      199,
    ],
